...
void WalletGui::ReceiveFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ReceiveFrame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject WalletGui::ReceiveFrame::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_WalletGui__ReceiveFrame.data,
    qt_meta_data_WalletGui__ReceiveFrame,
    qt_static_metacall,
    nullptr,
    nullptr
} };
