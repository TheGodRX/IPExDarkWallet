...
QT_MOC_LITERAL(5, 77, 6) // "_index"

    },
    "WalletGui::TransactionsFrame\0exportToCsv\0"
    "\0showTransactionDetails\0QModelIndex\0"
    "_index"
};
...
void WalletGui::TransactionsFrame::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TransactionsFrame *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject WalletGui::TransactionsFrame::staticMetaObject = { {
    &QFrame::staticMetaObject,
    qt_meta_stringdata_WalletGui__TransactionsFrame.data,
    qt_meta_data_WalletGui__TransactionsFrame,
    qt_static_metacall,
    nullptr,
    nullptr
} };
