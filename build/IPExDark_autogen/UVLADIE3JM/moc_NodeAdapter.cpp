...
void WalletGui::NodeAdapter::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<NodeAdapter *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (NodeAdapter::*)(quint64 );
        ...
        {
            using _t = void (NodeAdapter::*)(quintptr );
        ...
        {
            using _t = void (NodeAdapter::*)(Node * * , const CryptoNote::Currency * , INodeCallback * , Logging::LoggerManager * , const CryptoNote::CoreConfig & , const CryptoNote::NetNodeConfig & );
        ...
        {
            using _t = void (NodeAdapter::*)(Node * * );
...
QT_INIT_METAOBJECT const QMetaObject WalletGui::NodeAdapter::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_WalletGui__NodeAdapter.data,
    qt_meta_data_WalletGui__NodeAdapter,
    qt_static_metacall,
    nullptr,
    nullptr
} };
